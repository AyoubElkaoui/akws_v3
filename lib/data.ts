...
export const DIENSTEN = [
  {
    ...
    price: { v: 'v.a. €2.250', m: '€85/mnd', d: '3 tot 4 wkn' },
  },
  {
    n: '02',
    sub: 'Vindbaarheid',
    ...
    price: { v: 'v.a. €3.750', m: 'incl. bij Pro', d: 'doorlopend' },
  },
  {
    n: '03',
    sub: 'Op maat gebouwd',
    ...
    price: { v: 'v.a. €4.000', m: 'per fase', d: '4 tot 8 wkn' },
  },
  {
    n: '04',
    sub: 'Doorlopend beheer',
    titel: 'Onderhoud & support',
    body: "Hosting, SSL, updates, beveiliging, kleine wijzigingen. Verplicht onderdeel van elk traject, vanaf €85 per maand. Zo blijft je site snel, veilig en actueel zonder dat jij erover hoeft na te denken.",
    ...
    price: { v: '€85/mnd', m: 'v.a. €145 bij Pro', d: 'doorlopend' },
  },
];
...
export const BRANCHE_DETAILS: BrancheDetail[] = [
  {
    ...
    metaDescription: 'Specialistische websites voor loodgieters in Hilversum, Baarn, Soest, Bussum en omgeving. Vindbaar voor spoedklussen, vaste prijzen vanaf €2.250.',
    ...
    faq: [
      ...
      { q: "Wat kost een Google Ads-campagne voor mijn loodgietersbedrijf?", a: "Het beheer zit in het Pro-pakket (€145/mnd). Het advertentiebudget dat je aan Google betaalt staat los en bepaal je zelf. Realistisch begin je met €300 tot €600 per maand voor lokaal spoedwerk." },
  ...
  },
  {
    ...
    metaDescription: 'Websites voor CV-monteurs in Midden-Nederland. Vindbaar bij ketels, warmtepompen en storingen. Lokale SEO en Google Ads, vaste prijzen vanaf €2.250.',
  ...
  },
  {
    ...
    metaDescription: 'Websites voor elektriciens in Midden-Nederland. Vindbaar bij groepenkasten, laadpalen en zonnepanelen. Lokale SEO en Google Ads, vaste prijzen vanaf €2.250.',
    ...
    faq: [
      ...
      { q: "Hoeveel kost een laadpaal-campagne?", a: "Voor lokale laadpaal-campagnes praat je over €400 tot €800 advertentiebudget per maand, plus beheer (inbegrepen in Pro-pakket). De CPC's zijn hoger dan voor algemene termen, maar de waarde per lead is ook hoger." },
    ],
  },
  {
    ...
    metaDescription: 'Websites voor installatiebedrijven in Midden-Nederland. W- en E-installatie, totaalinstallateurs, lokale SEO en maatwerk software. Vaste prijzen vanaf €2.250.',
    ...
    faq: [
      ...
      { q: "Kunt u een klantportaal bouwen voor mijn vaste klanten?", a: "Ja, dat is maatwerk software. Een klantportaal waar klanten hun installatiehistorie, onderhoudsplanning, facturen en service-aanvragen zien. Reken op een budget vanaf €8.000 voor een eenvoudige versie." },
  ...
  },
  {
    ...
    metaDescription: 'Websites voor dakdekkers in Midden-Nederland. Vindbaar bij daklekkage, platdak renovatie en spoedklussen. Lokale SEO en Google Ads, vaste prijzen vanaf €2.250.',
...
export const PRIJZEN = [
  {
    naam: 'Starter',
    sub: 'Voor wie online vindbaar wil zijn',
    prijs: '€2.250',
    eenh: 'eenmalig + €85/mnd',
    bullets: [
      "Maatwerk ontwerp in jouw huisstijl",
      "Tot 6 pagina's",
      "Mobiel-first & snel",
    ...
    cta: 'Plan strategiegesprek',
    feat: false,
  },
  {
    naam: 'Pro',
    sub: 'Voor wie wil groeien via Google',
    prijs: '€3.750',
    eenh: 'eenmalig + €145/mnd',
    bullets: [
      "Alles uit Starter",
      "Tot 12 pagina's",
  ...
  },
  {
    ...
    sub: 'Voor wie meer dan een website nodig heeft',
    prijs: 'v.a. €4.000',
    eenh: 'vaste prijs per fase',
    bullets: [
      "Intake en procesanalyse",
      "Maatwerk software op jouw processen",
      "Koppelingen met Snelstart, Exact, Moneybird",
      "Urenregistratie, planning of klantportaal",
      "Hosting en onderhoud inbegrepen",
      "Demo's tijdens de bouw",
    ],
