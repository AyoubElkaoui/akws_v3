...
export const BRANCHES = [
  ...
  { naam: 'Transport & logistiek', sub: 'Koeriers, spoedtransport', slug: 'transport-logistiek' },
  { naam: 'Zonnepanelen & laadpalen', sub: 'Zon, thuisbatterij, laadpaal', slug: 'zonnepanelen-laadpalen' },
  { naam: 'Stukadoors & afbouw', sub: 'Stucwerk & sierpleister', slug: 'stukadoors' },
  { naam: 'Autobedrijven', sub: 'Onderhoud, APK, reparatie', slug: 'autobedrijven' },
];
...
export const BRANCHE_DETAILS: BrancheDetail[] = [
  ...
  },
  {
    ...
    sectorLabel: 'TRANSPORT & LOGISTIEK',
    metaTitle: 'Website laten maken voor transport- en koeriersbedrijven | AKWS',
    metaDescription: 'Websites voor transportbedrijven, koeriers en expediteurs in Midden-Nederland. Snel en betrouwbaar, met offerteflow en 24/7 spoedlijn. Prijzen op maat.',
    h1: 'Website laten maken voor transport & logistiek',
    subtitel: 'Snel en betrouwbaar online — net als je ritten. Voor koeriers, transporteurs en expediteurs.',
    lead: "In transport telt betrouwbaarheid en snelheid. Een opdrachtgever die met spoed een zending weg moet krijgen, wil binnen seconden zien dat jij het kunt én meteen contact kunnen leggen. Een trage of onduidelijke website kost je dan letterlijk ritten. Je site moet dezelfde professionaliteit uitstralen als je service.",
    overzichtTekst: "Koeriers, spoedtransport, contractvervoer, internationaal en gekoeld transport. B2B-gedreven, waar betrouwbaarheid, certificeringen en snelle bereikbaarheid de doorslag geven.",
    pijnpunten: [
      { titel: "Opdrachtgevers vinden me niet snel genoeg bij spoed", tekst: "Bij spoedtransport telt elke minuut. Als een expediteur je niet binnen seconden vindt en kan bellen, gaat de rit naar een concurrent die wél direct bereikbaar is." },
      { titel: "Mijn certificeringen en betrouwbaarheid komen online niet over", tekst: "NIWO-vergunning, TLN-lidmaatschap, eigen wagenpark — dat wekt vertrouwen bij zakelijke opdrachtgevers. Als dat niet prominent op je site staat, mis je serieuze klanten." },
      { titel: "Ik krijg losse ritjes terwijl ik contractvervoer wil", tekst: "Vaste routes en contractklanten zijn stabiele omzet. Als je site alleen spoed uitstraalt, trek je vooral eenmalige ritten aan. De juiste indeling trekt ook structurele opdrachtgevers." },
      { titel: "Mijn site maakt geen onderscheid tussen soorten transport", tekst: "Express, internationaal, gekoeld, nacht — elk vraagt andere info en andere klanten. Eén algemene pagina overtuigt niemand echt." },
    ],
    oplossingen: [
      { titel: "Snelle site met directe bereikbaarheid", tekst: "Een razendsnelle, mobiel-first website met een prominente spoedlijn en offerteknop, altijd één tap weg. Bij spoed hoeft niemand te zoeken." },
      { titel: "Vertrouwen vooraan voor B2B", tekst: "Certificeringen (NIWO, TLN), eigen wagenpark en concrete cijfers prominent in beeld. Precies wat expediteurs en logistiek verantwoordelijken willen zien voor ze bellen." },
      { titel: "Aparte pagina's per transportdienst", tekst: "Express, contractvervoer, internationaal, nacht- en gekoeld transport — elk een eigen pagina met eigen zoekwoorden en doelgroep." },
    ],
    zoekwoorden: [
      "spoedkoerier [stad]", "koeriersdienst [stad]", "transportbedrijf [stad]", "sneltransport",
      "expediteur transport", "gekoeld transport", "internationaal transport", "same day levering",
    ],
    faq: [
      { q: "Bouw je ook een offerte- of trackingsysteem?", a: "Een offerteflow zit standaard in de site. Voor tracking of een klantportaal maak ik maatwerk software — dat bespreken we los, op basis van wat je nodig hebt." },
      { q: "Werk je alleen voor grote transportbedrijven?", a: "Nee, juist ook voor koeriers en kleinere transporteurs. Zo bouwde ik de website voor Zando Transport, een spoedkoerier uit Soest. Elk bedrijf krijgt een aanpak op maat." },
      { q: "Kan ik zelf teksten en diensten aanpassen?", a: "Ja. Ik lever de site desgewenst met een CMS zodat je diensten, teksten en FAQ zelf beheert, zonder telkens een developer nodig te hebben." },
      { q: "Hoe snel kan mijn nieuwe site live?", a: "Afhankelijk van de omvang meestal binnen enkele weken. Na een gratis kennismaking krijg je een vast bod met planning op papier." },
    ],
  },
  {
    slug: 'zonnepanelen-laadpalen',
    naam: 'Zonnepanelen & laadpalen',
    sectorLabel: 'ZONNE-ENERGIE & LADEN',
    metaTitle: 'Website laten maken voor zonnepaneel- en laadpaal-installateurs | AKWS',
    metaDescription: 'Websites voor installateurs van zonnepanelen, thuisbatterijen en laadpalen in Midden-Nederland. Vindbaar voor hoogwaardige leads. Prijzen op maat.',
    h1: 'Website laten maken voor zonnepanelen & laadpalen',
    subtitel: 'Vindbaar voor de groeimarkt: zonnepanelen, thuisbatterijen en laadpalen — particulier én zakelijk.',
    lead: "De markt voor zonne-energie en laden groeit hard, maar de concurrentie ook. Grote landelijke spelers domineren de algemene zoektermen. Jouw kans zit lokaal: 'zonnepanelen installateur [stad]' of 'laadpaal thuis [stad]'. Daar win je van anonieme grote partijen — mits je website er klaar voor is en de juiste, hoogwaardige leads aantrekt.",
    overzichtTekst: "Zonnepanelen, omvormers, thuisbatterijen en laadpalen (thuis en zakelijk). Snelgroeiende markt met hoogwaardige leads, waar lokale vindbaarheid en vertrouwen de doorslag geven.",
    pijnpunten: [
      { titel: "Grote landelijke installateurs pakken alle online vraag", tekst: "Op 'zonnepanelen' landelijk ben je kansloos tegen de grote spelers. Op lokale termen — 'zonnepanelen installateur [stad]' — win je juist, als je site daarvoor is ingericht." },
      { titel: "Ik krijg kleine klusjes tussen mijn grote installaties", tekst: "Een laadpaal of complete zonne-installatie is hoogwaardig werk. Als je formulier niet filtert, kost het je tijd aan kleine vragen. Een goed ingedeelde site trekt de juiste leads." },
      { titel: "Klanten weten niet dat ik ook thuisbatterijen of zakelijke laadpalen doe", tekst: "De markt verschuift naar opslag en zakelijk laden. Als je site dat niet laat zien, mis je juist de meest waardevolle opdrachten." },
      { titel: "Subsidie- en terugverdien-vragen kosten veel uitlegtijd", tekst: "Klanten oriënteren zich lang en vragen naar subsidie en terugverdientijd. Goede content beantwoordt dat vooraf en positioneert je als expert." },
    ],
    oplossingen: [
      { titel: "Lokale SEO voor jouw werkgebied", tekst: "Vindbaar op 'zonnepanelen installateur [stad]' en 'laadpaal laten installeren'. Per kernplaats een eigen landingspagina, Google Bedrijfsprofiel ingericht." },
      { titel: "Diensten gesplitst per specialisatie", tekst: "Aparte pagina's voor zonnepanelen, thuisbatterij, laadpaal-thuis en zakelijke laadoplossingen — elk met eigen zoekwoorden en call-to-action." },
      { titel: "Content die oriënterende klanten binnenhaalt", tekst: "Pagina's over subsidie, terugverdientijd en het proces trekken klanten die nog aan het oriënteren zijn, en bouwen autoriteit op voor ze een offerte aanvragen." },
    ],
    zoekwoorden: [
      "zonnepanelen installateur [stad]", "laadpaal laten installeren [stad]", "thuisbatterij installateur", "zakelijke laadpaal",
      "zonnepanelen offerte", "omvormer vervangen", "laadpaal thuis", "zonnepanelen subsidie",
    ],
    faq: [
      { q: "Moet ik me specialiseren of alles laten zien?", a: "Laat alles zien wat je doet, maar geef elke dienst een eigen pagina. Een klant zoekt op één term — die pagina moet overtuigen. Specialiseren op je site is anders dan je bedrijf afkappen." },
      { q: "Kan ik leads filteren op particulier of zakelijk?", a: "Ja, met een veld in het formulier (particulier / zakelijk / grootzakelijk) of aparte formulieren. Zo zie je vooraf welk type aanvraag binnenkomt." },
      { q: "Werkt SEO nog of moet ik vooral Google Ads draaien?", a: "Beide. Lokale SEO is goed haalbaar en Ads ondersteunt op competitieve termen. In de kennismaking bekijk ik wat past bij je werkgebied en concurrentie." },
      { q: "Kunnen jullie koppelen met een offerte- of ontwerptool?", a: "Als je tool een koppeling toelaat, kan dat. We bekijken het bij de intake zodat een aanvraag zo min mogelijk overtypwerk oplevert." },
    ],
  },
  {
    slug: 'stukadoors',
    naam: 'Stukadoors & afbouw',
    sectorLabel: 'STUKADOOR & AFBOUW',
    metaTitle: 'Website laten maken voor stukadoors en afbouwbedrijven | AKWS',
    metaDescription: 'Websites voor stukadoors, sierpleisteraars en afbouwbedrijven in Midden-Nederland. Visueel portfolio, vindbaar voor stucwerk. Prijzen op maat.',
    h1: 'Website laten maken voor stukadoors',
    subtitel: 'Een visuele site die je strakke stucwerk laat zien en klanten overtuigt op vakmanschap.',
    lead: "Stucwerk verkoopt op beeld en vertrouwen. Een klant kiest de stukadoor van wie het werk er strak uitziet — dus je website is in de eerste plaats een portfolio. Zonder goede foto's van afgerond werk win je het van niemand, ook al lever je uitstekend werk. Met een sterk portfolio en lokale vindbaarheid trek je juist de mooie projecten aan.",
    overzichtTekst: "Stucwerk, sierpleister, spachtelputz, tegelwerk en overig afbouwwerk. Visueel en vertrouwensgedreven, waar een portfolio van afgerond werk de doorslag geeft.",
    pijnpunten: [
      { titel: "Mijn mooiste werk zien mensen alleen in de woningen zelf", tekst: "Je levert strak stucwerk, maar niemand ziet het. Zonder een visueel portfolio online mis je de klant die kiest op basis van beeld — en dat is bij afbouw bijna iedereen." },
      { titel: "Ik concurreer met klussers die veel goedkoper zijn", tekst: "Op prijs win je niet van een ZZP'er met een emmer stuc. Op zichtbaar vakmanschap wél. Een sterke site verschuift het gesprek van prijs naar kwaliteit." },
      { titel: "Ik krijg vooral kleine reparatieklusjes", tekst: "Complete wanden, sierpleister en nieuwbouwprojecten zijn je waardevolste werk. Als je site dat niet uitstraalt, trek je vooral gaatjes-dichten aan." },
      { titel: "Klanten weten niet dat ik ook sierpleister of tegelwerk doe", tekst: "Als je site alleen 'stukadoor' zegt, mis je aanvragen voor je specialistische en beter betaalde werk. Aparte diensten maken duidelijk wat je aankan." },
    ],
    oplossingen: [
      { titel: "Beeld-gedreven portfolio-website", tekst: "Grote, snelle foto's van je strakste projecten, ingedeeld per type: gladpleisterwerk, sierpleister, spachtelputz, tegelwerk. Je werk verkoopt zichzelf." },
      { titel: "Lokale SEO voor stucwerk in je regio", tekst: "Vindbaar op 'stukadoor [stad]' en 'stucwerk laten doen'. Per kernplaats een eigen landingspagina, Google Bedrijfsprofiel ingericht met foto's." },
      { titel: "Offerteflow die serieuze projecten filtert", tekst: "Een aanvraagformulier dat vraagt naar type werk, oppervlakte en wensen. Zo filter je vooraf de complete projecten van de kleine reparaties." },
    ],
    zoekwoorden: [
      "stukadoor [stad]", "stucwerk laten doen [stad]", "sierpleister aanbrengen", "spachtelputz stukadoor",
      "gladpleisterwerk", "tegelzetter [stad]", "afbouwbedrijf [stad]", "stucwerk offerte",
    ],
    faq: [
      { q: "Ik heb weinig goede projectfoto's, wat nu?", a: "Vanaf nu maak je bij elk project foto's met je telefoon — dat is goed genoeg. Voor bestaand werk gebruiken we wat er is en vullen aan met heldere beschrijvingen. Geen stockfoto's; die herkent een klant meteen." },
      { q: "Hoe belangrijk zijn foto's echt voor een stukadoorsite?", a: "Cruciaal. Stucwerk wordt bijna volledig op beeld verkocht. We zorgen dat je foto's groot, snel en goed geordend op de site staan." },
      { q: "Doe je ook sites voor complete afbouwbedrijven?", a: "Ja. Stucwerk, tegelwerk, wanden en plafonds — elk als eigen dienst met eigen pagina en zoekwoorden, zodat elke klant de juiste pagina vindt." },
      { q: "Hoe snel sta ik bovenaan voor 'stukadoor [mijn stad]'?", a: "Lokale SEO is een kwestie van maanden, geen dagen. Met een goede basis en Google Bedrijfsprofiel zie je meestal binnen enkele maanden beweging; met Google Ads eerder." },
    ],
  },
  {
    slug: 'autobedrijven',
    naam: 'Autobedrijven & garages',
    sectorLabel: 'AUTOBEDRIJF & GARAGE',
    metaTitle: 'Website laten maken voor autobedrijven en garages | AKWS',
    metaDescription: 'Websites voor garages en autobedrijven in Midden-Nederland. Vindbaar voor APK, onderhoud en reparatie, met online afspraak en reviews. Prijzen op maat.',
    h1: 'Website laten maken voor autobedrijven',
    subtitel: 'Vindbaar voor APK, onderhoud en reparatie — met online afspraak en reviews die vertrouwen wekken.',
    lead: "Een garage kiest de klant vaak dichtbij en op vertrouwen. Als iemand zoekt op 'APK [stad]' of 'garage in de buurt', wil hij snel zien dat je betrouwbaar bent, wat het ongeveer kost en hoe hij een afspraak maakt. Een verouderde site zonder reviews of online afspraak kost je die klant aan de garage om de hoek die het wél goed heeft geregeld.",
    overzichtTekst: "Onderhoud, APK, reparatie, banden en occasions. Lokaal en vertrouwensgedreven, waar reviews, bereikbaarheid en een makkelijke afspraak de doorslag geven.",
    pijnpunten: [
      { titel: "Ik sta niet bovenaan voor 'APK' of 'garage' in mijn plaats", tekst: "De meeste klanten zoeken lokaal en kiezen uit de top 3. Sta je daar niet, dan gaan onderhoud en APK naar de garage die er wél in heeft geïnvesteerd." },
      { titel: "Klanten bellen liever dan dat ze online een afspraak maken", tekst: "Elk telefoontje kost jou tijd. Een online afspraak- of aanvraagmodule vangt klanten buiten openingstijden en scheelt je administratie." },
      { titel: "Mijn goede reviews staan verspreid en niemand ziet ze", tekst: "Voor een garage is vertrouwen alles. Als je beoordelingen nergens gebundeld staan, verlaag je de drempel niet om jou te kiezen." },
      { titel: "Mijn occasions krijgen online weinig aandacht", tekst: "Als je ook auto's verkoopt, is een verouderde of onvindbare occasion-pagina direct gemiste omzet." },
    ],
    oplossingen: [
      { titel: "Lokale SEO voor APK, onderhoud en reparatie", tekst: "Vindbaar op 'APK [stad]', 'garage [stad]' en 'auto onderhoud [stad]'. Google Bedrijfsprofiel volledig ingericht met openingstijden, foto's en diensten." },
      { titel: "Online afspraak of aanvraag", tekst: "Een simpele module waarmee klanten 24/7 een afspraak of offerte aanvragen. Minder telefoontjes, meer geboekte klussen." },
      { titel: "Reviews en occasions in beeld", tekst: "Beoordelingen prominent op de site, plus een nette occasion-sectie als je auto's verkoopt. Vertrouwen en aanbod direct zichtbaar." },
    ],
    zoekwoorden: [
      "garage [stad]", "APK keuring [stad]", "auto onderhoud [stad]", "autobedrijf in de buurt",
      "banden wisselen [stad]", "auto reparatie [stad]", "occasions [stad]", "airco auto bijvullen",
    ],
    faq: [
      { q: "Kan ik een online afspraaksysteem krijgen?", a: "Ja. Een simpele afspraak-/aanvraagmodule zit standaard in de site. Wil je een uitgebreid boekingssysteem met agenda-koppeling, dan maak ik maatwerk — dat bespreken we los." },
      { q: "Kunnen mijn occasions op de site?", a: "Ja, met een overzichtelijke occasion-sectie. Voor grotere voorraden kunnen we een koppeling of beheer inrichten zodat je auto's makkelijk toevoegt en verwijdert." },
      { q: "Hoe krijg ik meer reviews op mijn site?", a: "We richten een simpele review-vraag in na een klus (Google en op je site). Vraag je er actief naar, dan groeit het snel — ik help je die routine op te zetten." },
      { q: "Ik heb al een website, kan ik alleen beter vindbaar worden?", a: "Soms wel, soms niet. Ik check eerst je huidige site. Als die qua snelheid en mobiel in orde is, kan ik los lokale SEO en Google Ads doen; anders is een nieuwe basis slimmer." },
    ],
  },
];
...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    content: [
      ...
      { kind: 'h2', text: 'Wat "maanden wachten" je écht kost', id: 'kosten' },
      { kind: 'p', text: 'Stel: je nieuwe site levert je gemiddeld twee extra aanvragen per maand op. Voor een installateur is dat al snel een paar duizend euro aan werk. Elke maand dat je site níet live is, laat je dat geld liggen. Bij een doorlooptijd van vier maanden praat je dus niet over "een paar maanden geduld" — je praat over vier maanden gemiste omzet. Dat is de verborgen prijs van traagheid, en die staat op geen enkele offerte.' },
      { kind: 'p', text: 'Daar komt bij: de wereld staat niet stil. Terwijl jij wacht, laat je concurrent zijn site wél vernieuwen, verzamelt hij reviews en klimt hij in Google. Een voorsprong die je later alleen met veel moeite weer inhaalt.' },
      { kind: 'h2', text: 'Waar die maanden bij bureaus in gaan zitten', id: 'bureaus' },
      { kind: 'p', text: 'Als een website "maanden" duurt, ligt dat zelden aan het bouwen zelf. Het zit in het proces eromheen:' },
      { kind: 'ul', items: [
        '**Wachten op elkaar** — jij wacht op het bureau, het bureau wacht op jouw feedback, en er gaan weken verloren aan e-mails over en weer.',
        '**Eindeloze rondjes** — versie 1, 2, 3, 4… omdat er vooraf geen duidelijke scope was afgesproken.',
        '**Content die blijft liggen** — teksten en foto’s die "nog moeten komen" en het hele project ophouden.',
        '**Overleg om het overleg** — meetings die weinig opleveren behalve een gevoel van voortgang.',
      ] },
      { kind: 'p', text: 'Ik knip dat allemaal weg. Eén kennismaking om de scope scherp te krijgen, ik schrijf zelf de teksten (jij checkt), en je ziet elke paar dagen een werkende versie. Geen wachten, geen ruis.' },
      { kind: 'h2', text: 'Voor wie werkt dit — en voor wie niet', id: 'voor-wie' },
      { kind: 'p', text: 'Eerlijk is eerlijk: die twee weken gelden voor een professionele bedrijfswebsite — van een installateur, transporteur, hovenier of ander MKB. Heb je een grote webshop met honderden producten of complexe maatwerk software nodig, dan duurt dat langer, en dat hoor je vooraf. Voor de meeste vakbedrijven is een snelle, vindbare site die aanvragen oplevert precies wat nodig is — en die staat binnen twee weken live.' },
  ...
  },
  {
    ...
    content: [
      ...
      { kind: 'h2', text: 'Wat is die lokale 3-pack precies?', id: 'drie-pack' },
      { kind: 'p', text: 'Zoek eens op "elektricien Baarn" of "loodgieter in de buurt". Bovenaan zie je een kaartje van Google Maps met drie bedrijven eronder: naam, sterren, openingstijden, een belknop en een routebeschrijving. Dat is de lokale 3-pack. Onderzoek laat keer op keer zien dat het overgrote deel van de klikken naar die drie bedrijven gaat — de rest van pagina 1 krijgt de kruimels. Je hele doel met lokale SEO is simpel: in dat kaartje komen.' },
      { kind: 'p', text: 'En het mooie: die 3-pack draait niet op wie de grootste is of het meeste advertentiebudget heeft. Hij draait op relevantie, afstand en bekendheid — en die kun je alle drie beïnvloeden met een goed profiel.' },
      { kind: 'h2', text: '3 fouten die je onder in de resultaten houden', id: 'fouten' },
      { kind: 'ul', items: [
        '**Een half ingevuld profiel** — geen diensten, geen foto’s, verkeerde categorie. Google kan dan niet inschatten waar je goed voor bent, dus toont het je liever niet.',
        '**Geen of oude reviews** — een bedrijf met drie reviews van twee jaar geleden oogt inactief. Recentheid en aantal tellen allebei mee.',
        '**Naam, adres en telefoon die niet overal kloppen** — als je gegevens op je website anders staan dan in je profiel of in bedrijvengidsen, twijfelt Google en zak je.',
      ] },
      { kind: 'h2', text: 'Reviews: de brandstof van je profiel', id: 'reviews' },
      { kind: 'p', text: 'Van alle knoppen die je kunt indrukken, is actief om reviews vragen de krachtigste. Reviews doen twee dingen tegelijk: ze overtuigen de klant die twijfelt, én ze geven Google een sterk signaal dat je een levend, gewaardeerd bedrijf bent. Vraag er dus standaard om na elke tevreden klus, en reageer op wat binnenkomt — ook op de kritische reviews. Dat laat toekomstige klanten zien hoe je met problemen omgaat.' },
      { kind: 'h2', text: 'Hoe snel zie je resultaat?', id: 'resultaat' },
      { kind: 'p', text: 'Sneller dan met "gewone" SEO. Waar het maanden duurt om met je website hoog te komen, kan een compleet ingericht profiel met de eerste reviews al binnen enkele weken zichtbaar verschil maken in de lokale resultaten. Het is daarmee de goedkoopste, snelste winst die er is — en de basis waar je website op voortbouwt.' },
  ...
  },
  {
    ...
    content: [
      ...
      { kind: 'h2', text: 'Hoeveel reviews heb je nodig?', id: 'hoeveel' },
      { kind: 'p', text: 'Er is geen magisch getal, maar er zijn wel drempels. Onder de tien reviews twijfelen mensen nog. Rond de twintig à dertig recente reviews met een gemiddelde van 4,5 of hoger word je serieus genomen. Belangrijker dan het exacte aantal is de trend: een bedrijf dat elke maand een paar nieuwe reviews binnenkrijgt, oogt levend en betrouwbaar. Eén stapel van drie jaar geleden doet veel minder.' },
      { kind: 'h2', text: 'Wat te doen met een negatieve review', id: 'negatief' },
      { kind: 'p', text: 'Een negatieve review is geen ramp — het is een kans om te laten zien wat voor bedrijf je bent. Reageer altijd: rustig, professioneel, en gericht op een oplossing. Toekomstige klanten lezen niet alleen de klacht, maar vooral hóe je reageert. Een nette, oplossingsgerichte reactie op één kritische review wekt vaak méér vertrouwen dan tien perfecte vijf-sterren. Ga nooit in de verdediging of in discussie; dat schrikt juist af.' },
      { kind: 'h2', text: 'Reviews en je Google-ranking', id: 'ranking' },
      { kind: 'p', text: 'Reviews overtuigen niet alleen mensen, ze helpen ook Google. Het aantal, de recentheid en zelfs de wóórden in je reviews wegen mee in de lokale ranking. Een klant die schrijft "snel geholpen bij een lekkage in Soest" geeft Google precies de signalen die je nodig hebt om te scoren op "loodgieter Soest". Reviews zijn dus tegelijk je verkoopargument én gratis SEO.' },
      { kind: 'h2', text: 'Zet ze niet alleen op Google', id: 'op-je-site' },
      { kind: 'p', text: 'Veel bedrijven verzamelen reviews op Google en vergeten ze op hun eigen website te tonen. Zonde. Een bezoeker die op je site landt, moet dat vertrouwen daar meteen zien — niet eerst wegklikken naar Google om het te zoeken. Een blok met je beste, echte reviews op de homepage en bij je contactpagina verhoogt merkbaar het aantal aanvragen.' },
  ...
  },
  {
    ...
    content: [
      ...
      { kind: 'h2', text: '5. Vindbaar voor de juiste zoektermen', id: 'seo' },
      { kind: 'p', text: 'Een transportbedrijf wordt op heel andere termen gezocht dan een winkel. Denk aan "spoedkoerier [stad]", "same day levering", "gekoeld transport" of "expediteur [regio]". Dat zijn specifieke, koopgerichte zoekopdrachten van mensen die nú iets weg moeten krijgen. Een site die per dienst een eigen, goed geschreven pagina heeft — met precies die woorden — pakt dat verkeer. Eén algemene "over ons"-pagina doet dat niet.' },
      { kind: 'h2', text: 'Waarom een template niet werkt voor transport', id: 'template' },
      { kind: 'p', text: 'Een kant-en-klaar website-sjabloon is gemaakt voor "een bedrijf", niet voor jóuw bedrijf. Het weet niets van spoedlijnen, van het verschil tussen express en contractvervoer, of van de certificeringen waar expediteurs op letten. Het resultaat is een site die er misschien aardig uitziet, maar die de bezoeker niet doet wat hij moet doen: bellen of een offerte aanvragen. Maatwerk betekent dat elke keuze — van de plek van de spoedknop tot de volgorde van je diensten — is gemaakt met jouw klant in gedachten.' },
      { kind: 'quote', text: 'Als jouw belofte is dat een zending binnen 45 minuten onderweg is, moet je website die snelheid en betrouwbaarheid vanaf de eerste seconde uitstralen. Dat lukt niet met een sjabloon.', cite: 'De aanpak bij Zando Transport' },
      { kind: 'h2', text: 'De rol van een CMS', id: 'cms-rol' },
      { kind: 'p', text: 'Tarieven, diensten en werkgebieden veranderen in de logistiek regelmatig. Als je voor elke wijziging een developer moet bellen, blijft je site achterlopen. Daarom lever ik transportsites met een eenvoudig CMS: je past teksten, diensten en veelgestelde vragen zelf aan, en de wijziging staat direct live. Je site blijft zo net zo wendbaar als je bedrijf.' },
  ...
  },
  {
    ...
    content: [
      ...
      { kind: 'h2', text: 'Wat een nieuwe website je oplevert', id: 'oplevert' },
      { kind: 'p', text: 'Een verouderde site vervangen is geen kostenpost, het is een investering met een terugverdientijd. Een snelle, moderne site die goed vindbaar is en duidelijk converteert, doet drie dingen tegelijk: meer bezoekers (via betere vindbaarheid), meer van die bezoekers die contact opnemen (via een duidelijke call-to-action), en meer vertrouwen (via een professionele uitstraling en reviews). Bij elkaar hoef je maar een handvol extra klussen per jaar binnen te halen om de investering ruimschoots terug te verdienen.' },
      { kind: 'h2', text: 'Doe deze snelle zelfcheck', id: 'zelfcheck' },
      { kind: 'p', text: 'Twijfel je nog? Loop deze vijf vragen langs. Beantwoord je er twee of meer met "nee", dan is het serieus tijd:' },
      { kind: 'ol', items: [
        'Laadt je site op je telefoon binnen een paar seconden zonder dat er dingen door elkaar springen?',
        'Sta je op de eerste pagina van Google als je zoekt op je vak plus je stad?',
        'Kan een bezoeker binnen één tap bellen of een aanvraag doen?',
        'Staan er recente foto’s van je werk en klantreviews op?',
        'Kun je zelf een tekst of foto aanpassen zonder iemand te bellen?',
      ] },
      { kind: 'h2', text: 'Vervangen hoeft niet duur of traag te zijn', id: 'snel' },
      { kind: 'p', text: 'De grootste reden dat mensen een slechte site laten staan, is de angst voor een lang, duur traject. Terecht, want zo werkt het bij veel bureaus. Bij mij niet: een nieuwe website staat binnen twee weken live, tegen een vaste prijs die je vooraf weet. Geen maandenlange verbouwing, geen verrassingen achteraf. Een verouderde site is dus geen probleem dat je nog jaren voor je uit hoeft te schuiven.' },
  ...
  },
  {
    ...
    authorAv: 'AE',
    gradient: 'linear-gradient(135deg, #4c1d95 0%, #2e1065 60%, #7c3aed 100%)',
    cover: '/blog-covers/werkbon-naar-factuur-in-10-seconden.jpg',
    featured: true,
    content: [
      {
        kind: 'p',
  ...
  },
  {
    ...
    authorAv: 'AE',
    gradient: 'linear-gradient(135deg, #7c3aed 0%, #4c1d95 100%)',
    cover: '/blog-covers/lokale-seo-loodgieter-top-3.jpg',
    content: [
  ...
  },
  {
    ...
    authorAv: 'AE',
    gradient: 'linear-gradient(135deg, #1a0f33 0%, #4c1d95 100%)',
    cover: '/blog-covers/5-fouten-op-installateur-websites.jpg',
    content: [
  ...
  },
  {
    ...
    cover: '/blog-covers/ad-loodgieter-meer-aanvragen-google-ads.jpg',
    content: [
  ...
  },
  {
    ...
    cover: '/blog-covers/excel-planning-vervangen.jpg',
    content: [
  ...
  },
  {
    ...
    cover: '/blog-covers/snelstart-koppelen-met-werkbon-app.jpg',
    content: [
  ...
  },
  {
    ...
    cover: '/blog-covers/google-ads-installateur-beginnen.jpg',
    content: [
  ...
  },
  {
    ...
    authorAv: 'AE',
    gradient: 'linear-gradient(135deg, #c2521b 0%, #4c1d95 100%)',
    cover: '/blog-covers/avg-voor-installateurs.jpg',
    content: [
  ...
  },
  {
    ...
    cover: '/blog-covers/geen-uurtjes-factuurtjes.jpg',
    content: [
